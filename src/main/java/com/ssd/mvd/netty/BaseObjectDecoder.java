...
public abstract class BaseObjectDecoder extends ChannelInboundHandlerAdapter {
    ...
    public void channelRead( ChannelHandlerContext ctx, Object msg ) {
        ...
        try {
            ...
            if (decodedMessage == null) decodedMessage = handleEmptyMessage(ctx.channel(), ctx.channel().remoteAddress(), msg);
        ...
        } catch ( Exception e ) { KafkaDataControl.getInstance().clear(); }
        finally { ReferenceCountUtil.release( msg ); } }

    protected Object handleEmptyMessage( Channel channel, SocketAddress remoteAddress, Object msg ) { return null; }
